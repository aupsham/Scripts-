/*
	Run with:
	frida -U -f [APP_ID] -l multiplesslbypass.js --no-pause
*/
...
setTimeout(function() {
	Java.perform(function () {
		...
		try {
			...
			okhttp3_Activity_4.check.overload('java.lang.String', '[Ljava.security.cert.X509Certificate;').implementation = function (a, b) {		
